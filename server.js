...
app.post('/dologin', function(req, res) {
  ...
  db.collection('people').findOne({"login.username":uname}, function(err, result) {
    ...
    if(result.login.password == pword){ req.session.loggedin = true; window.document.getElementById("profileButton").href="/profile?username=<%= user.login.username %>"; res.redirect('/') }
